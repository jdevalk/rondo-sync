 ...
 * and detecting conflicts between Sportlink and Stadion.
 */
 ...
 */
const SYNC_ORIGIN = {
  /** Manual edit in Stadion WordPress */
  USER_EDIT: 'user_edit',
  /** Forward sync from Sportlink to Stadion */
  SYNC_FORWARD: 'sync_sportlink_to_stadion',
  /** Reverse sync from Stadion to Sportlink */
  SYNC_REVERSE: 'sync_stadion_to_sportlink'
};

/**
 * Fields that have bidirectional timestamp tracking.
 * Each field has two timestamp columns: {field}_stadion_modified and {field}_sportlink_modified
 */
 ...
 * @returns {{stadion: string, sportlink: string}} Object with column names
 *
 * @example
 * // Returns { stadion: 'email_stadion_modified', sportlink: 'email_sportlink_modified' }
