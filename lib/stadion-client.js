...
/**
 * Make an authenticated request to Stadion with retry logic for transient errors.
 ...
 * @returns {Promise<{status: number, body: any}>}
 */
async function stadionRequestWithRetry(endpoint, method, body = null, options = {}, maxRetries = 3) {
  let lastError;
...
module.exports = { stadionRequest, stadionRequestWithRetry, testConnection };
