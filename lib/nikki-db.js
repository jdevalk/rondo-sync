 ...
 */
function computeContributionHash(knvbId, year, nikkiId, saldo, status) {
 ...
 * Each contribution: { knvb_id, year, nikki_id, saldo, status }
 */
 ...
 * Returns: [{ knvb_id, year, nikki_id, saldo, status }]
 */
function getContributionsByKnvbId(db, knvbId) {
  const stmt = db.prepare(`
    SELECT knvb_id, year, nikki_id, saldo, status
 ...
 * Returns: Map<knvb_id, [{ year, nikki_id, saldo, status }]>
 */
