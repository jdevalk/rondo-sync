# Roadmap: Rondo Sync v2.2 - Discipline Cases
...
- [x] **Phase 31: Stadion Sync with Season Organization** - Create/update cases in Stadion with ACF fields and season categories
- [x] **Phase 32: Pipeline Integration** - Weekly cron, email reports, CLI command
...
**Plans:** 1 plan
Plans:
- [x] 31-01-PLAN.md - Extend discipline-db.js and create sync script
...
**Plans:** 1 plan
Plans:
- [x] 32-01-PLAN.md - Create pipeline orchestrator and integrate with sync infrastructure
...
| 31. Stadion Sync with Season Organization | 1/1 | Complete | 2026-02-03 |
| 32. Pipeline Integration | 1/1 | Complete | 2026-02-03 |
