...
- [ ] **Phase 30: Download Discipline Cases** - Capture cases from Sportlink via browser automation
...
**Success Criteria** (what must be TRUE):
  ...
  2. DisciplineClubCasesPlayer API response is captured via page.on('response')
...
|-------|----------------|--------|-----------|
| 30. Download Discipline Cases | 0/? | Not started | - |
| 31. Stadion Sync with Season Organization | 0/? | Not started | - |
