...
must_haves:
  ...
  key_links:
    ...
    - from: "submit-stadion-sync.js"
      to: "Stadion REST API /rondo/v1/people/{id}/activities"
...
- Stadion activity endpoint: `POST /rondo/v1/people/{person_id}/activities` with `content`, `activity_type` fields
