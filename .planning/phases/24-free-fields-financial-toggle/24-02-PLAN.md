...
```
  ...
  <verify>
Run: `grep -E "reverse\)" /Users/joostdevalk/Code/sportlink-sync/scripts/sync.sh`
...
Also update the echo/display messages that show the user what cron entries will be created to include reverse sync.
  ...
  <verify>
Run: `grep -E "\*/15.*reverse" /Users/joostdevalk/Code/sportlink-sync/scripts/install-cron.sh`
