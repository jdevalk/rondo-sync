...
must_haves:
  ...
  key_links:
    ...
    - from: "upload-photos-to-stadion.js"
      to: "Stadion API"
      via: "multipart/form-data POST to /rondo/v1/people/{id}/photo"
