...
must_haves:
  ...
  key_links:
    ...
    - from: "submit-stadion-sync.js"
      ...
      via: "parent tracking and member mapping functions"
      pattern: "upsertParents|getParentsNeedingSync|getAllTrackedMembers"
---
...
async function runSync(options = {}) {
  ...
  // After member sync, build KNVB ID to Stadion ID mapping from ALL tracked members
