...
10. On failure (non-zero exit): touch /tmp/rondo-sync-retry
11. Pipe output to mail command with custom subject: "Rondo Sync Report - $(date +%Y-%m-%d)"
...
6. Build CRON_ENTRIES variable with:
   ...
   - Retry job: 0 8 * * * checking for /tmp/rondo-sync-retry flag file
