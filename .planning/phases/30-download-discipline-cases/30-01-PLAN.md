...
6. **Handle nulls gracefully:** Use nullish coalescing for optional fields (e.g., `caseData.AdministrativeFee ?? null`)
  ...
  <verify>
Run: `node -e "const db = require('./lib/discipline-db'); console.log(Object.keys(db))"`
Expected: Outputs array containing openDb, upsertCases, getAllCases, getCaseCount
  </verify>
  <done>
lib/discipline-db.js exports openDb, initDb, upsertCases, getAllCases, getCasesByPersonId, getCaseCount functions following established SQLite patterns
  </done>
</task>
